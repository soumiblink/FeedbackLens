...
export default function DecisionCenter() {
  ...
  const loadData = async () => {
    ...
    try {
      ...
      console.error(err);
      setError(err.response?.data?.detail || 'Failed to load decision data');
    } finally {
      setLoading(false);
    }
  };
